    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
      @forelse ($menu as $m)
        <div class="menu-card bg-white rounded-xl shadow-md hover:shadow-xl transition overflow-hidden">
          ...
          {{-- GAMBAR MENU (MENGGUNAKAN ACCESSOR LANGSUNG) --}}
          ...
          <div class="p-5">
            ...
            <div class="mb-4">
              @if ($m->stok > 10)
                <span class="text-green-600 font-semibold text-sm">Stok: {{ $m->stok }}</span>
              @elseif ($m->stok > 0)
                <span class="text-yellow-600 font-semibold text-sm">Stok menipis: {{ $m->stok }}</span>
              @else
