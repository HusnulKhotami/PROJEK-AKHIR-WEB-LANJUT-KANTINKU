            ...
            <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                ...
                <td class="px-8 py-4">
                    <div class="text-sm space-y-1">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            {{ $i->menu->nama }} 
                            <span class="text-gray-500">({{ $i->jumlah }})</span>
                        </div>
                        @endforeach
                    </div>
                </td>
                ...
                <td class="px-8 py-4 text-center">
                    <div class="flex justify-center gap-2">
                        <button onclick="openModal('{{ $p->id }}','{{ $p->status }}')" class="px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold transition-colors text-sm flex items-center gap-1">
                            <i class="fas fa-edit"></i> Update
                        </button>

                        @if(in_array($p->status,['selesai','dibatalkan']))
                        <button onclick="openDeleteModal('{{ $p->id }}')" class="px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 font-semibold transition-colors text-sm flex items-center gap-1">
